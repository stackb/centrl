...
func (FunctionParamRole) Descriptor() protoreflect.EnumDescriptor {
	return file_stardoc_output_stardoc_output_proto_enumTypes[1].Descriptor()
}

func (FunctionParamRole) Type() protoreflect.EnumType {
	return &file_stardoc_output_stardoc_output_proto_enumTypes[1]
}
...
func (x *OriginKey) Reset() {
	*x = OriginKey{}
	mi := &file_stardoc_output_stardoc_output_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OriginKey) Descriptor() ([]byte, []int) {
	return file_stardoc_output_stardoc_output_proto_rawDescGZIP(), []int{15}
}
...
const file_stardoc_output_stardoc_output_proto_rawDesc = "" +
	"\n" +
	"#stardoc_output/stardoc_output.proto\x12\x0estardoc_output\"\xae\x04\n" +
	"\n" +
	"ModuleInfo\x125\n" +
...
var file_stardoc_output_stardoc_output_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_stardoc_output_stardoc_output_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
