...
class GitHubSourceFileComponent extends Component {
     ...
     */
    constructor(module, moduleVersion, filePath, templateFn, opt_templateData, opt_domHelper) {
        super(opt_domHelper);
    ...
    createDom() {
        ...
        this.setElementInternal(soy.renderAsElement(this.templateFn_, templateData));
    }
