...
ModuleVersionInfo = provider(
    ...
    fields = {
        ...
        "deps": "!List<!ModuleDependencyInfo>: List of dependency targets providing ModuleDependencyInfo",
        "transitive_deps": "!DepSet<!ModuleDependencyInfo>: transitive list of dependency targets providing ModuleDependencyInfo",
        "source": "!ModuleSourceInfo: Source target providing ModuleSourceInfo",
